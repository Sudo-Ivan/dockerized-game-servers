...
- SteamCMD defaults to anonymous login. If download fails, set STEAM_USERNAME and STEAM_PASSWORD for an account that owns Team Fortress 2. Add STEAM_GUARD_CODE if Steam asks for it
