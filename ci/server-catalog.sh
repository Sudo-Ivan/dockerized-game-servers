...
emit "the-forest" "the-forest/docker-compose.yml" "the-forest" "data" "FOREST_FORCE_UPDATE" "process" "1"
emit "sons-of-the-forest" "sons-of-the-forest/docker-compose.yml" "sons-of-the-forest" "data" "SOTF_FORCE_UPDATE" "process" "1"
emit "sniper-elite-4" "sniper-elite-4/docker-compose.yml" "sniper-elite-4" "data" "SE4_FORCE_UPDATE" "process" "1"
emit "supertuxkart" "supertuxkart/docker-compose.yml" "supertuxkart" "data" "-" "process" "1"
...
emit "rtcw" "rtcw/docker-compose.yml" "rtcw" "data" "-" "process" "1"
emit "etl" "etl/docker-compose.yml" "etl" "data" "ETL_FORCE_UPDATE" "process" "1"
...
emit "longvinter" "longvinter/docker-compose.yml" "longvinter" "data" "LONGVINTER_FORCE_UPDATE" "process" "1"
emit "barotrauma" "barotrauma/docker-compose.yml" "barotrauma" "data" "BAROTRAUMA_FORCE_UPDATE" "process" "1"
emit "unturned" "unturned/docker-compose.yml" "unturned" "data" "UNTURNED_FORCE_UPDATE" "process" "1"
emit "tf2" "tf2/docker-compose.yml" "tf2" "data" "TF2_FORCE_UPDATE" "process" "1"
emit "cs2" "cs2/docker-compose.yml" "cs2" "data" "CS2_FORCE_UPDATE" "process" "1"
emit "dod-source" "dod-source/docker-compose.yml" "dod-source" "data" "DOD_FORCE_UPDATE" "process" "1"
emit "gmod" "gmod/docker-compose.yml" "gmod" "data" "GMOD_FORCE_UPDATE" "process" "1"
emit "delta-force-bhd" "delta-force-bhd/docker-compose.yml" "delta-force-bhd" "data" "-" "process" "1"
emit "dont-starve-together" "dont-starve-together/docker-compose.yml" "dont-starve-together" "data" "DST_FORCE_UPDATE" "process" "1"
emit "v-rising" "v-rising/docker-compose.yml" "v-rising" "data" "VRISING_FORCE_UPDATE" "process" "1"
emit "enshrouded" "enshrouded/docker-compose.yml" "enshrouded" "data" "ENSHROUDED_FORCE_UPDATE" "process" "1"
emit "satisfactory" "satisfactory/docker-compose.yml" "satisfactory" "data" "SATISFACTORY_FORCE_UPDATE" "process" "1"
emit "windrose" "windrose/docker-compose.yml" "windrose" "data" "WINDROSE_FORCE_UPDATE" "process" "1"
emit "vein" "vein/docker-compose.yml" "vein" "data" "VEIN_FORCE_UPDATE" "process" "1"
...
emit "azerothcore" "azerothcore/docker-compose.yml" "azerothcore-worldserver" "data" "-" "none" "0"
